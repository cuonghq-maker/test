					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">438 style found</p>
								<div class="clearfix"></div>
							</div>
								...
								<div class="col-sm-4">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp->id)}}"><img src="{{Voyager::image($img)}}" alt="" height="250px"></a>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									@endif
										<div class="single-item-header">
											<a href="product.html"><img src="{{Voyager::image($img)}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
